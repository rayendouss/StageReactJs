        ...
        <MDBNavbar className="headerSite" >
            <div className="container-fluid">
                <div className="headerPage">
                    <div >
                      <img src='assets/images/logo.png' style = {{ width : 150, height : 60, marginLeft : 1350 }} alt='الاخبارية التونسية'   />
                    </div>
                        ...
                        <div className="social">
                            ...
                            <Nav className="row">
                              <div className="toggle">
                                ...
                                <NavItem className="ite" style={{marginLeft:280}} >
                                    <NavLink className="nlink10" to='/contactus' style={{textDecoration: 'none'}}>من نحن</NavLink>
                                </NavItem>
                                <NavItem className="ite" style={{marginLeft:20}}>
                                ...
                                <NavDropdown className="ite" title="سياسة"  style={{marginLeft:20,top:"-10px" ,color:"white"}}  >
